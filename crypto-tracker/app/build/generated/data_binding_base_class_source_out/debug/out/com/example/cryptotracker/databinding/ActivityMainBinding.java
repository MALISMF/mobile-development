...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ScrollView rootView, @NonNull Button btnRefresh,
      @NonNull Button btnStartService, @NonNull Button btnStopService, @NonNull CardView cardPrices,
      @NonNull TextView tvError, @NonNull TextView tvJpy, @NonNull TextView tvLastUpdate,
      @NonNull TextView tvRub, @NonNull TextView tvStatus, @NonNull TextView tvUsd) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ScrollView) rootView, btnRefresh, btnStartService,
          btnStopService, cardPrices, tvError, tvJpy, tvLastUpdate, tvRub, tvStatus, tvUsd);
    }
